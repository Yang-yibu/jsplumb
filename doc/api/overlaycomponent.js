...
* @property OverlayCapableJsPlumbUIComponent.overlays
* @type {List.<Overlay>}
*/
...
* use `getLabelOverlay`.
* @method OverlayCapableJsPlumbUIComponent.getLabel
* @see {@link #getOverlay}
* @see {@link #getLabelOverlay}
*/

/**
* @method OverlayCapableJsPlumbUIComponent.getLabelOverlay
...
* @method OverlayCapableJsPlumbUIComponent.getOverlay
...
* @method OverlayCapableJsPlumbUIComponent.removeOverlays
...
* @method OverlayCapableJsPlumbUIComponent.setLabel
...
* @method OverlayCapableJsPlumbUIComponent.addOverlay
